...
/**
 * @brief 接收器时间跟踪间隔 - 0x13
 *
 */
typedef uint32_t dw1000_reg_rx_ttcki_t;

/**
 * @brief 接收机时间跟踪偏移 - 0x14
 *
 */
typedef union {
    uint8_t value[5];
...
/**
 * @brief 子寄存器 GPIO_RAW - 0x26:28 - RW
 *
 */
typedef union {
    uint8_t value[4];
...
/**
 * @brief 子寄存器 TC_PG_STATUS - 0x2A:09 - RW
 *
 */
typedef union {
    uint8_t value[2];
