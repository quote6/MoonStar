...
/* 定义 SPI 句柄 用于api里的SPI操作 */
#define DECA_SPI_Handle                 hspi1
/* 根据实际情况设置SPI的时钟的预分频系数 高速不能超过20MHz，低速不能超过3MHz */
#define DECA_SPI_LOW_SPEED_PRESCALER    SPI_BAUDRATEPRESCALER_64
#define DECA_SPI_HIGH_SPEED_PRESCALER   SPI_BAUDRATEPRESCALER_8
/* 宏定义供用户选择，可以直接在cubemx里对引脚命名，或者在进行宏定义 */
#if 1
#define DW_RESET_Pin        DWM1000_RSTn_Pin
#define DW_RESET_GPIO_Port  DWM1000_RSTn_GPIO_Port
#define DW_IRQn_Pin         DWM1000_IRQ_Pin
#define DW_IRQn_GPIO_Port   DWM1000_IRQ_GPIO_Port
#define DW_NSS_Pin          DWM1000_SPI_NSS_Pin
#define DW_NSS_GPIO_Port    DWM1000_SPI_NSS_GPIO_Port
/* LCD 引脚未使用，给 NULL 参数 */
#define LCD_NSS_Pin         NULL
#define LCD_NSS_GPIO_Port   NULL
#define LCD_RS_Pin          NULL
#define LCD_RS_GPIO_Port    NULL
#define LCD_RW_Pin          NULL
#define LCD_RW_GPIO_Port    NULL
#endif
