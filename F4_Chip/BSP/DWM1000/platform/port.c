...
void port_set_dw1000_slowrate(void) {
    DECA_SPI_Handle.Init.BaudRatePrescaler = DECA_SPI_LOW_SPEED_PRESCALER;
    HAL_SPI_Init(&DECA_SPI_Handle);
}
...
void port_set_dw1000_fastrate(void) {
    DECA_SPI_Handle.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_8;
    HAL_SPI_Init(&DECA_SPI_Handle);
}
